'''
Adapted from https://github.com/amazon-science/ReFinED
(which is adapted from https://medium.com/@amimahloof/how-to-package-a-python-project-with-all-of-its-dependencies-for-offline-install-7eb240b27418)
'''
...
class Package(Command):
    ...
    def run(self):
        ...
        final_commands = [
            f"tar -C dist -xvf dist/{PKG_NM_N_VERSION}.tar.gz",
            f"rm dist/{PKG_NM_N_VERSION}.tar.gz",
            f"tar -czvf dist/{PKG_NM_N_VERSION}.tar.gz dist/{PKG_NM_N_VERSION}",
        ]
